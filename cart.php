        ...
        <?php
                                // Else Countcart
                                    ...
                                    <div class="empty">
                                        ...
                                        <h1><i class="fas fa-minus-circle fa-lg"></i> Your shopping cart is empty <i class="fas fa-minus-circle fa-lg"></i></h1>
                                    </div>
                            <?php     }
                                }else{ ?>
                                    <div class="empty">
                                    ...
                                    <h1><i class="fas fa-minus-circle fa-lg"></i> You must be logged in to view the cart <i class="fas fa-minus-circle fa-lg"></i></h1>
                                    </div>
                            <?php } ?>
    </div>
</div>
